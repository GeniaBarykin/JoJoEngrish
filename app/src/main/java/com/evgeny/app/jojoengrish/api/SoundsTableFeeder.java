...
public abstract class SoundsTableFeeder {
    ...
    public static void feed(DbHelper db){
        ...
        db.postSound("Dio WRY (scared)", R.raw.dio_wry_scared, R.drawable.dio_wry_scared,
                "Intense vampire noise.");
        db.postSound("Dio WRY (angry)", R.raw.dio_wry, R.drawable.dio_wry,
                "Battle cry of a true warrior.");
        db.postSound("Dio wry (quiet)", R.raw.dio_wry_quiet, R.drawable.dio_wry_quiet,
